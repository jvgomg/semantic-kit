/**
 * Structure:js View Content Component
 *
 * Custom TUI rendering for the Structure:js command using the expandable sections framework.
 * Displays the hydrated (JavaScript-rendered) structure analysis.
 */
...
import type { StructureJsInternalResult } from '../../../commands/structure/index.js'
import type {
  StructureWarning,
  LandmarkNode,
  LandmarkSkeleton,
...
/**
 * Main Structure:js View Content component
 */
export function StructureJsViewContent({
  data,
  height,
}: ViewComponentProps<StructureJsInternalResult>): ReactNode {
  const { hydrated: analysis, axeResult, timedOut } = data
