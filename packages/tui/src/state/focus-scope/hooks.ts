...
/**
 * Legacy useFocus hook for backward compatibility during migration.
 *
 * @deprecated Use useFocusRegion instead.
 *
 * @example
 * ```tsx
 * // Old API
 ...
 * ```
 */
export function useFocus(region: string): {
  isFocused: boolean
  isInputActive: boolean
  focus: () => void
} {
  return useFocusRegion({ region })
}

/**
 * Legacy useFocusManager hook for backward compatibility during migration.
 *
 * @deprecated Use useFocusNavigation instead.
 * Note: enableFocus/disableFocus are no longer needed - scopes handle this automatically.
 *
 * @example
 * ```tsx
 * // Old API
 ...
 *
 * // New API (enableFocus/disableFocus are no-ops)
...
export function useFocusManager(): {
  ...
  focusNext: () => void
  focusPrevious: () => void
  /** @deprecated No longer needed - scopes handle this automatically */
  enableFocus: () => void
  /** @deprecated No longer needed - scopes handle this automatically */
  disableFocus: () => void
  /** @deprecated Always returns true in the new system */
  ...
  return {
    ...
    focusNext,
    focusPrevious,
    // These are no-ops in the new system - focus scoping handles this automatically
    enableFocus: () => {},
    disableFocus: () => {},
    focusEnabled: true,
  }
