 ...
 */
export declare function extractPageMetadata(html: string): PageMetadata;
/**
 ...
 */
export declare function buildSocialPreview(openGraph: Record<string, string>, twitter: Record<string, string>, pageMetadata: PageMetadata, targetUrl: string): SocialPreview;
/**
 ...
 */
export declare function buildPreview(tags: SocialTags, pageMetadata: PageMetadata, targetUrl: string): SocialPreview;
